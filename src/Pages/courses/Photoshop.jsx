...
import photoshop from "../../images/pss.jpg";
import photoshopPdf from "../../assets/Photoshop.pdf";
...
const [formData, setFormData] = useState({
  ...
  phone: "",
  email: "",
  course: "Photoshop Creative Training",
  message: "",
});
...
`;
 ...
 const handleSyllabusDownload = async () => {
       ...
       `;
           ...
           link.href = photoshopPdf;
           link.download = "Photoshop-Creative.pdf";
 ...
 {showSyllabusForm && (
  <div className="form-overlay">
    <div className="form-box">
      ...
      <div className="photoshop-banner">
        <h1>Adobe Photoshop Training</h1>
        <p>Master Photo Editing & Graphic Designing</p>
      </div>
      ...
      <div className="course-page">
        ...
        <div className="course-box">
          ...
          <div className="course-img">
            <img src={photoshop} alt="Photoshop Training" />
          </div>

          <div className="course-content">

            <h2>About Photoshop Course</h2>

            <p>
              Learn Adobe Photoshop from beginner to advanced level.
              This course covers photo editing, image retouching,
              banner design, poster design, social media creatives,
              branding materials and professional graphic designing
              techniques with practical projects.
            </p>
